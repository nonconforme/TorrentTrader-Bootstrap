...
if (strtoupper(substr(PHP_OS, 0, 3)) == "WIN") {
	if (!class_exists("COM")) { ?>
		...
		<p class="text-center">COM support not available</p>
...
<ul class="list-unstyled">
	...
	<li><?php echo T_("CURRENT_LOAD"); ?>: <strong><?php echo $loadnow; ?></strong></li>
	<li><?php echo T_("LOAD_5_MINS"); ?>: <strong><?php echo $load5; ?></strong></li>
	<li><?php echo T_("LOAD_15_MINS"); ?>: <strong><?php echo $load15; ?></strong></li>
	<hr />
	<li>OS: <strong><?php echo $operatingsystem; ?></strong></li>
	<li><?php echo T_("RAM_USED"); ?>: <strong><?php echo $memused; ?> / <?php echo $memtotal; ?></strong></li>
	<li><?php echo T_("UPTIME"); ?>: <strong><?php echo $up; ?></strong></li>
</ul>
<?php }
end_block();
?>